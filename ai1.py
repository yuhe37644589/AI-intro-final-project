...
# 再從剩下的 90% 裡切出 10% 驗證集（也就是總體資料的 0.1）
...
classifier = classifier = RandomForestClassifier(n_estimators=200, max_depth=None, n_jobs=-1, random_state=42)
